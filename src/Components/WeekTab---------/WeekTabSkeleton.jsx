function WeekTabSkeleton({ className = "" }) {
  const weekDaysArr = ["", "", "", "", "", "", ""];
  return (
    <>
      <div className={`absolute z-10 h-fit w-full sm:h-full ${className}`}>
        <div className="flex flex-col sm:grid sm:grid-rows-[auto_1fr] lg:grid-rows-[auto_3fr] gap-5 sm:gap-y-4 h-full">
          <div className="p-2 relative h-auto overflow-x-auto flex flex-col gap-2">
            <h3>Дни недели</h3>

            <div className="w-fit flex justify-between gap-1 xs:w-full xs:gap-1">
              {weekDaysArr.map(() => {
                return (
                  <div className="flex skeleton h-30 sm:h-32 lg:h-34 flex-col items-center rounded-md w-15 gap-3 lg:w-20 card-bg">
                    <div className="">
                      <h3></h3>
                    </div>
                    <div className=""></div>
          ...
          <div className="grid grid-rows-6 xs:grid-rows-3 xs:grid-cols-2 lg:grid-rows-2 lg:grid-cols-3 gap-5 sm:gap-4 min-h-0">
            ...
            <div className="relative card-bg highlight grid grid-rows-[1fr_1fr_1fr_1fr] grid-cols-2 gap-y-2 justify-items-center">
...
export default WeekTabSkeleton;
