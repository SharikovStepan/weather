function DayTabSkeleton({ className = "" }) {
  return (
    <>
      <div className={`absolute z-10 h-fit w-full sm:h-full ${className}`}>
        <div className="h-full flex flex-col sm:grid sm:grid-rows-[auto_1fr] lg:grid-rows-[auto_3fr] gap-10 sm:gap-y-4">
          <div className="p-2 relative h-auto overflow-hidden card-bg">
            <h3>Часы</h3>
            <div className="skeleton w-full h-41 sm:h-50 grid grid-rows-[auto_1fr] gap-2">
              <div className="">
                <div className=""></div>
              </div>
              <div className=""></div>
