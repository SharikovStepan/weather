...
function DayHighlights(props) {
  const uvStroke = 100 - (5 * 100) / 13;
  console.log('DayHighlights',props.loadingStage,);
  ...
  return (
    <>
      <div className="relative grid grid-rows-6 xs:grid-rows-3 xs:grid-cols-2 lg:grid-rows-2 lg:grid-cols-3 gap-5 sm:gap-3 min-h-0">
        ...
        {props.loadingStage != "complete" && <DayHighlightsSkeleton onAnimationEnd={props.onAnimationEnd} className={props.loadingStage == "fading" ? "fade-out-loading" : ""}></DayHighlightsSkeleton>}
        ...
        <div className="relative card-bg highlight flex justify-around">
          <div className="grid grid-rows-[1fr_2fr_1fr] justify-items-center gap-2">
            ...
            <div className="highlight-value">11:20</div>
          </div>
          <div className="grid grid-rows-[1fr_2fr_1fr] justify-items-center gap-2">
        ...
        <div className="relative card-bg highlight grid grid-rows-[1fr_1fr_1fr_1fr] grid-cols-2 gap-y-3 sm:gap-y-0 lg:gap-y-2 justify-items-center">
        ...
        <div className="card-bg highlight flex flex-col justify-between">
          ...
          <div className="grid grid-cols-5 col-span-2">
            ...
            <div className="highlight-value text-6xl sm:text-5xl self-center col-start-3 justify-self-center">5</div>
          </div>
        ...
        <div className="card-bg highlight grid grid-rows-[1fr_2fr_2fr] sm:grid-rows-3 justify-items-center gap-5 sm:gap-1">
          ...
          <div className="text-3xl">
            <span className="highlight-value">75</span> Км/ч
          </div>
        </div>
        ...
        <div className="card-bg highlight grid grid-rows-[1fr_2fr_2fr] sm:grid-rows-3 justify-items-center gap-5 sm:gap-1">
          ...
          <div className="text-3xl">
            <span className="highlight-value">75</span> %
          </div>
        </div>
        ...
        <div className="card-bg highlight grid grid-rows-[1fr_2fr_2fr] sm:grid-rows-3 justify-items-center gap-5 sm:gap-1">
          ...
          <div className="text-3xl">
            <span className="highlight-value">75</span> Км
          </div>
        </div>
      </div>
    </>
